...
function ThemeToggle({ darkMode, toggleDarkMode }) {
  return (
    <button
      ...
      className="fixed top-4 right-4 p-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95"
